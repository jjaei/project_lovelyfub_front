    ...
    <header className={styles.header}>
      <div className={styles.contents}>
        ...
        <nav className={styles.navigation}>
          <ul>
            {isLoggedIn ? (
              <span onClick={handleUserPageClick} className={isUserPage ? styles.userIconOrange : ''}>
                {isUserPage? (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
